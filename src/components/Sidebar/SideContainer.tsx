...
export default function SideContainer({ children }: Props) {
   return (
      <aside className="text-white fixed bottom-0 left-0 xl:top-0 xl:h-screen w-full xl:w-40 flex flex-row items-end pb-5 xl:flex-col justify-center xl:items-start z-30 xl:pl-16">
